    ...
    fetch("/api/projects", { signal: controller.signal })
      ...
      .catch((reason) => {
        if (!controller.signal.aborted)
          setError(reason.message || "Couldn't load projects.");
      })
      .finally(() => {
    ...
    <AppShell title="Your projects">
          ...
          <div className="empty-state">
            ...
            <p>
              {query
                ...
                : "Create a named project and keep it in your account."}
            </p>
          </div>
        )}
        {projects.length === 100 && (
          <p className="muted">
            Showing the 100 most recently updated projects.
          </p>
        )}
      </section>
      <dialog
        ref={dialog}
        className="runly-dialog"
      ...
      >
        <form noValidate onSubmit={create}>
          <h2 id="create-project-title">A name for your idea.</h2>
          ...
          />
          {formError && (
            <p role="alert" id="project-form-error">
              {formError}
            </p>
          )}
